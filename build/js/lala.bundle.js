...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0), __webpack_require__(2), __webpack_require__(5).setImmediate))
...
var _main_store = __webpack_require__(7);

var _main_store2 = _interopRequireDefault(_main_store);

var _liveClasifier = __webpack_require__(11);

var _liveClasifier2 = _interopRequireDefault(_liveClasifier);

var _predictClasifier = __webpack_require__(18);

var _predictClasifier2 = _interopRequireDefault(_predictClasifier);

var _trainClasifier = __webpack_require__(14);

var _trainClasifier2 = _interopRequireDefault(_trainClasifier);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

window.onload = function () {
	var LalaApp = new _vue2.default({
		el: '#lala_app',
		store: _main_store2.default,
		created: function created() {
			_main_store2.default.dispatch('fetchRandomFeedback');
			_main_store2.default.dispatch('fetchTrainingData');
		},

		components: {
			LiveClasifier: _liveClasifier2.default,
			PredictClasifier: _predictClasifier2.default,
			TrainClasifier: _trainClasifier2.default
		}
	});
};
...
exports.default = new _vuex2.default.Store({
	...
	getters: {
		getRandomFeedback: function getRandomFeedback(state) {
			return state.randomFeedback;
		},
		getTrainingTable: function getTrainingTable(state) {
			return state.trainingTable;
		}
	},
	mutations: {
		updateRandomFeedback: function updateRandomFeedback(state, data) {
			state.randomFeedback = data;
		},
		updateTrainingTable: function updateTrainingTable(state, data) {
			state.trainingTable = data;
		},
		updateAccuracy: function updateAccuracy(state, data) {
			state.accuracy = data;
		},
		updatePrediction: function updatePrediction(state, data) {
			state.prediction = data;
		}
	},
	actions: {
		fetchRandomFeedback: function fetchRandomFeedback(_ref) {
		...
		updateLabel: function updateLabel(_ref2, data) {
		...
		fetchTrainingData: function fetchTrainingData(_ref3) {
		...
		newTraining: function newTraining(_ref4) {
		...
		getPrediction: function getPrediction(_ref5, data) {
...
if (false) {(function () {  module.hot.accept()
  ...
  var id = "C:\\wamp\\www\\ai_clasifier\\src\\js\\views\\live-clasifier.vue"
  if (!module.hot.data) {
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\wamp\\www\\ai_clasifier\\src\\js\\views\\train-clasifier.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
module.exports = {
	...
	computed: {
		...
		precision_per_label: function precision_per_label() {
			var precisionText = 'N/A';

			if (this.$store.state.accuracy.precision) {
				precisionText = '';
				for (var label in this.$store.state.accuracy.precision) {
		...
		tableData: function tableData() {
			var table = [];
			var trainingTable = this.$store.state.trainingTable;
			console.log(this.$store.state.trainingTable);
			for (var index in trainingTable) {
				var tag = 1;
...
if (false) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "C:\\wamp\\www\\ai_clasifier\\src\\js\\views\\predict-clasifier.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, __vue_template__)
...
// <template>
// 	<div class="col-12 text-comfortaa mb-2">
// 		<div class="input-group">
// 			<span class="input-group-addon"><b class="text-primary">Lala</b>Clasifier</span>
// 			<input type="text" class="form-input" placeholder="I say ..." readonly :value="prediction">
// 			<button class="btn btn-info input-group-btn" @click="predict()"><i class="fa fa-eercast" aria-hidden="true"></i> Predict</button>
// 		</div>
// 	</div>
// </template>
//
...
module.exports = {
	name: 'predict-clasifier',
	created: function created() {},

	computed: {
		prediction: function prediction() {
			if (this.$store.state.prediction && this.$store.state.prediction.length > 0) {
				return this.$store.state.prediction[0];
			}
		}
	},
	methods: {
		predict: function predict() {
			this.$store.dispatch('getPrediction', { feedback: this.$store.state.randomFeedback.feedback });
		}
	},
	components: {}
	// </script>
...
/***/ })
/******/ ]);
//# sourceMappingURL=lala.bundle.js.map